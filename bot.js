...
client.on('ready', () => {
  client.user.setGame(`${prefix}help | Nay`); // Juego
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "info")) {
    message.channel.send(`**Bot Status:** ONLINE.\n**Detected bugs:** ${errores_detectados}\n**Version:** ${version}`);
  } else
  if (message.content.startsWith(prefix + "invite")) {
    message.channel.send("Right now we can't let this bot public, sorry.");
  } else
  if (message.content.startsWith(prefix + "8ball")) {
    if(!args[1]) return message.channel.send('Ask something 🔮.\n**Example:**');
    let pregunta = args.slice(0).join(" ");
    message.channel.send(`<@!${message.author.id}> ask «_${pregunta}_» 🔮 **${randomQuote()}**`);
  } else
  if (message.content.startsWith(prefix + "roll")) {
    message.channel.send('Your random number is ' + randomQuote4());
  } else
...
// TRADUCCION NECESARIA | TRANSLATION NEEDED
/*
client.on('message', async message => {
  var args = message.content.substring(prefix.length).split(" ");

  if (message.content.startsWith(prefix + "ugly")) {
    if(!message.mentions.members.first()) return message.channel.send("**Error:** Mention.\n**Uso:** `feo <@mención>`");
...
client.on('message', message => {
  ...
  if (message.content.startsWith(prefix + "broadcast")||message.content.startsWith(prefix + "bc")||message.content.startsWith(prefix + "announcement")) {
    if(message.author.id == "331641970910953473" && args[1]) {
      client.channels.get("517856035399008256").send(":loudspeaker: **Broadcast** :loudspeaker:\n( @everyone )\n\n" + text)
    } else if (args[1]) {
      message.channel.send("**Error:** You can't use this command. **Uso:** `bc|broadcast|announcement <anuncio>`")
    };
    if(!args[1]) {
      message.channel.send("**Error:** Parameters needed \n**Uso:** `bc|broadcast|announcement <anuncio>`")
    };
}});
/*
client.on('message', message => {
...
client.on('message', message => {
  if (message.content.startsWith(prefix + "seen")) {
    const embed = {
      "title": "",
      "description": "Seen <:visto:518634205710647296>",
      "color": 2335,
      "timestamp": new Date(),
    }
    message.channel.send({ embed })
...
client.on('message', message => {
  ...
  if (args[0] === `${prefix}f`) {
    if(args[1]) {
      var embed = {
        "title": "",
        "description": `**${message.author.username}** has paid respekts for ${args2}`,
        "color": 2335,
      };
    } else {
      var embed = {
        "title": "",
        "description": `**${message.author.username}** has paid respekts.`,
        "color": 2335,
      };
    }
    message.channel.send({ embed });
...
client.on('message', message => {
  ...
  if (message.content.startsWith(prefix + "help")) {
    ...
    const embed = {
      ...
      "description": "H-hello, I'm Nay, y-your assistant help. My prefix is » `" + prefix + "`",
      "color": 2335,
      "fields": [{
        "name": "Info",
      ...
      {
        "name": "Soon",
        "value": "N/A\n\nYou can find our Official Page [clicking here](http://anvi.cf/bot/ingles/)"
      }],
      "footer": {
        "text": "Thanks for use Nay!"
      },
    }
    message.channel.send({ embed })
  }
...
client.on('message', message => {
  ...
  if (message.content.startsWith(prefix + "mcskin")) {
    ...
    if (!args[1]) return message.channel.send('**Error:** Kind?\n**Uso:** `mcskin <avatar|helm|cube|bust|skin|avatar|armor> <uuid/nickname>`');
    if (!args[2]) return message.channel.send('**Error:** User?\n**Uso:** `mcskin <avatar|helm|cube|bust|skin|avatar|armor> <uuid/nickname>`');
    const embed = {
      "title": "",
      "author": {
        "name": args[2],
...
//chiste shld be used only on anvibot
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "currency")) {
    ...
    const embed = {
      ...
      "description": "Latest update: `" + res.body.result.updated + "`",
      "color": 2335,
      "fields": [
      {
        "name": "Info",
        "value": `${res.body.result.source} (1) → ${res.body.result.target} (${res.body.result.value})`
      }, /*
      {
...
// Only spanish memes will recieve
/*
client.on('message', async message => {
  var args = message.content.substring(prefix.length).split(" ");
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "neko")) {
    ...
    const embed = {
      "title": "",
      "description": "<@!" + message.author.id + ">, here you have catsss",
      "color": 2335,
      "footer": {
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "hug")) {
    const args = message.content.slice(prefix.length).trim().split(/ +/g);
    const args2 = args.slice(1).join(" ")
    let text = "<@!" + message.author.id + "> is hugging " + args2;
    if(!args2) text = "Don't you worry buddy, I'll give you a hug";
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "kiss")||message.content.startsWith(prefix + "beso")) {
    const args = message.content.slice(prefix.length).trim().split(/ +/g);
    const args2 = args.slice(1).join(" ")
    let text = "<@!" + message.author.id + "> is kissing " + args2;
    if(!args2) text = "I know you're alone, so... *kisses*";
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "baka")) {
    const args = message.content.slice(prefix.length).trim().split(/ +/g);
    const args2 = args.slice(1).join(" ")
    let text = message.mentions.members.first() + " is a BAKA BAKA BAKAAAAA! <:tontotonto:427349831393083393>";
    if(!message.mentions.members.first()) text = "<@!" + message.author.id + "> must be a real BAKA <:tontotonto:427349831393083393>";
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "slap")) {
    const args = message.content.slice(prefix.length).trim().split(/ +/g);
    const args2 = args.slice(1).join(" ")
    let text = "<@!" + message.author.id + "> slapped " + message.mentions.members.first() + ", debió doler.";
    if(!message.mentions.members.first()) text = "<@!" + message.author.id + "> slapped him/herself...?";
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "smug")) {
    const args = message.content.slice(prefix.length).trim().split(/ +/g);
    const args2 = args.slice(1).join(" ")
    let text = "<@!" + message.author.id + "> is being smug towards " + message.mentions.members.first() + ", hehe";
    if(!message.mentions.members.first()) text = "<@!" + message.author.id + "> is looking a bit smug";
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "feed")) {
    const args = message.content.slice(prefix.length).trim().split(/ +/g);
    const args2 = args.slice(1).join(" ")
    let text = "<@!" + message.author.id + "> is feeding " + message.mentions.members.first() + ", aww :heart:";
    if(!message.mentions.members.first()) return message.channel.send("**Name someone to feed him/her >u<!**")
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "cat")) {
    ...
    const args2 = args.slice(1).join(" ")
    let text = "Cats owo";
    if(!message.mentions.members.first()) text = "Cats owo";
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "pat")) {
    const args = message.content.slice(prefix.length).trim().split(/ +/g);
    const args2 = args.slice(1).join(" ")
    let text = "<@!" + message.author.id + "> is patting " + args2 + " <:pat:455391227785773066>";
    if(!args2) text = "Ok, I'll pat you,  <@!" + message.author.id + "> <:pat:455391227785773066>";
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "lewd")) {
    ...
    const args2 = args.slice(1).join(" ")
    let text = "...";
    if(!message.channel.nsfw) return message.channel.send(":underage: **NSFW Command** :underage:");
...
client.on('message', async message => {
  if (message.content.startsWith(prefix + "fetchgenius")) {
    ...
    const args2 = args.slice(1).join(" ");
    if(!args[1]) return message.channel.send("**Error:** You didn't specify a song.");
    ...
    if(!res.body.response.hits[0].result) return message.channel.send(`No matches! :(`);
